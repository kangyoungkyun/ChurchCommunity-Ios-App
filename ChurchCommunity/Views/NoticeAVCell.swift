...
class NoticeAVCell: UITableViewCell {
    ...
    let show: UIButton = {
        ...
        //starButton.addTarget(self, action: #selector(loginAction), for: .touchUpInside)
    ...
    func setLayout(){
        ...
        show.topAnchor.constraint(equalTo: dateLabel.topAnchor, constant: 0).isActive = true
        show.trailingAnchor.constraint(equalTo: containerView.trailingAnchor,constant: -10).isActive = true
